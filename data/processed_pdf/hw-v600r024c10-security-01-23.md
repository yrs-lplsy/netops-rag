# S1700, S5700, S6700 V600R024C10 配置指南-安全 01-23 二层流量限制配置
...
依赖License二层流量限制无需License许可即可使用。
硬件依赖表 23-1 支持本特性的硬件
