# S1700, S5700, S6700 V600R025C00 配置指南-安全 01-18 HIPS配置
...
| 非法root用户检测 | UID是用户身份标识，UID 0是保留给root用户的，设备中出现UID为 0的非root帐号是十分可疑的。HIPS检测到设备中出现UID为0的非 root帐号时会发送相关日志。 |
