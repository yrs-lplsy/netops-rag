...
- **杠杆②待人工决策**：7 条低分中 3 条属参数知识泄漏（prompt 收紧直接可修，其中 1 条轻微）；
...
- **结论**：杠杆②未达标（f 净 -0.046、rel -0.064）。目标泄漏条目确有修复证据（答案层面明确、
